...
@recipes = ["git", "setup", "email", "gems", "readme", "tests", "dvelp_devise", "dvelp_init", "frontend", "dvelp_admin", "dvelp_deployment", "dvelp_extras"]
@prefs = {:admin=>"activeadmin", :authentication=>"devise", :authorization=>"none", :ban_spiders=>false, :better_errors=>true, :continuous_testing=>"guard", :database=>"postgresql", :deployment=>"heroku", :dev_webserver=>"webrick", :devise_modules=>"default", :disable_turbolinks=>true, :drop_database=>true, :email=>"mandrill", :fixtures=>"factory_girl", :form_builder=>"none", :frontend=>"none", :github=>false, :local_env_file=>"figaro", :pg_username=>"", :pg_host=>"", :prod_webserver=>"unicorn", :pry=>true, :quiet_assets=>true, :rubocop=>true, :rvmrc=>false, :skip_seeds=>true, :templates=>"erb", :tests=>"rspec"}
@gems = []
...
# >-------------------------- templates/recipe.erb ---------------------------start<
# >--------------------------------[ devise ]---------------------------------<
@current_recipe = "dvelp_devise"
@before_configs["dvelp_devise"].call if @before_configs["dvelp_devise"]
say_recipe 'devise'
@configs[@current_recipe] = config
...
# >-------------------------- templates/recipe.erb ---------------------------start<
# >---------------------------------[ init ]----------------------------------<
@current_recipe = "dvelp_init"
@before_configs["dvelp_init"].call if @before_configs["dvelp_init"]
say_recipe 'init'
@configs[@current_recipe] = config
...
# >-------------------------- templates/recipe.erb ---------------------------start<
# >---------------------------------[ admin ]---------------------------------<
@current_recipe = "dvelp_admin"
@before_configs["dvelp_admin"].call if @before_configs["dvelp_admin"]
say_recipe 'admin'
config = {}
...
# >-------------------------- templates/recipe.erb ---------------------------start<
# >------------------------------[ deployment ]-------------------------------<
@current_recipe = "dvelp_deployment"
@before_configs["dvelp_deployment"].call if @before_configs["dvelp_deployment"]
...
# >-------------------------- templates/recipe.erb ---------------------------start<
# >--------------------------------[ extras ]---------------------------------<
@current_recipe = "dvelp_extras"
@before_configs["dvelp_extras"].call if @before_configs["dvelp_extras"]
say_recipe 'extras'
config = {}
